    ...
    <Layout title="Profile" hasTabBar>
      <div className="pb-16 px-4">
        ...
        <div className="mt-10 flex justify-around">
          <RoundedButton href={"/profile/sold"} label={"Sold list"}>
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <RoundedButton href={"/profile/bought"} label={"Bought list"}>
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <RoundedButton href={"/profile/favorite"} label={"Favorite list"}>
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
